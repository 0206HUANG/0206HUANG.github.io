# HUANG BOSHENG · Portfolio

Personal portfolio site, live at **https://0206huang.github.io**.

Hand-written HTML, CSS and vanilla JavaScript, with no build step and no framework, served by GitHub Pages.
...
Icons: [Font Awesome](https://fontawesome.com) (local) and [Devicon](https://devicon.dev) (CDN).
